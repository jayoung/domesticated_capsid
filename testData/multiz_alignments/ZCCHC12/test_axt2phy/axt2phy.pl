...
## JY this doesn't seem to work very well - may be designed for pairwise alignments rather than multiple

## https://metacpan.org/pod/distribution/GBrowse/contrib/AxtPairwise_convert/axt2phy.pl
## downloaded (JY) Nov 12, 2020
...
## JY commented these two lines out, which would be required if I wanted to make a wig file - will it still work?  Also commented out various other lines related to wig files
...
#                    "ID=Match_Wig_${species};species=$species;wigfile=$wigpath=$wigout",
                    "ID=Match_Wig_${species};species=$species",
                    )),"\n";
